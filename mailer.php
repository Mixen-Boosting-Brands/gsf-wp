...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $motivo = strip_tags(trim($_POST["motivo-contacto"] ?? ""));
    ...
    try {
        ...
        $mail->isHTML(true);
        $mail->Subject =
            "Nuevo mensaje enviado desde el sitio web de Grupo San Francisco";
        ...
        $mail->Body =
            ...
            <p><strong>Motivo de contacto:</strong> {$motivo}</p>
